<%-- 
    Document   : assign
    Created on : May 30, 2017, 10:55:04 AM
    Author     : Kolli
--%>
...
<br><body>
        ...
        <table align="center">
    <tr><td>Enter firstname:</td><td><input type="text" name="fn"></td></tr>    
    <tr><td>Enter lastname:</td><td><input type="text" name="ln"></td></tr>
    <tr><td>Enter work to assign:</td><td><input type="text" name="work"></td></tr>
